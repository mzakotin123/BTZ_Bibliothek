...
if (CB_Berufsbezeichnung.ItemIndex=0) then //wenn Fachinformatiker ausgewählt
  ...
  begin // Leeren aller Berufskombinationsfelder außer Berufsbezeichnung
    ...
    CB_Ausbildungsraum.Items.Add('RaumX');
  ...
  //wenn Mediengestalter ausgewählt
   ...
   //BOB=alle Räume im BTZ-Erdgeschoss außer RaumX (IngE-IT/MG) und
   //Toilettenräume
...
{ Aufgrund der Datensicherheit habe ich zwei konkrete BTZ-Raumnummern durch RaumX sowie RaumY für eine Veröffentlichung bei GitHub ersetzt.
  Fachrichtungen, Berufsbezeichnungen (einschließelich deren Abkürzungen) sowie die Abkürzungen für bestimmte Bereiche und Maßnahmen wie z. B. BOB (in dieser Anwendung jedoch als Ausbildungsraum verwendet) sind auf der Website des BTZ am BFW Leipzig zu finden, was bei konkreten Raumnummern dagegen nicht der Fall ist und ich diese deshalb auch nicht veröffentliche.   }
    ...
    begin
     ...
     if (CB_Fachrichtung.ItemIndex=1) or (CB_Fachrichtung.ItemIndex=2) then
      begin // wenn Hauswirtschaft oder Küche ausgewählt
       CB_Ausbildungsraum.Clear;
       CB_Ausbildungsraum.Items.Add('RaumY'); //Hauswirtschaftsküche
      end
